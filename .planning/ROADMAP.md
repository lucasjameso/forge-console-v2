...
- [x] 04.1-07-PLAN.md -- Content Pipeline: Add Content modal, Kanban drag, multi-platform
- [x] 04.1-08-PLAN.md -- Settings fixes: integration tests, feedback markdown, system tab
...
| 6. Content Pipeline Depth | 4/5 | In Progress|  |
